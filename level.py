...
def get_enemy(time,difficulty,enemy_list):
	...
	if difficulty == 1:		#
		if time == 10 or (time % 300 == 0 and time <= 1200):			###comes in after 1/3 of a second and reappears every 10 seconds.
			enemy_list.append(enemy.Enemy_0(time,50,800))
			enemy_list.append(enemy.Enemy_0(time,175,800))
			enemy_list.append(enemy.Enemy_0(time,300,800))
			enemy_list.append(enemy.Enemy_0(time,425,800))
			enemy_list.append(enemy.Enemy_0(time,550,800))
